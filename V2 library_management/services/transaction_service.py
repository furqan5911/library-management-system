...
#     Methods:
#         record_transaction(user_id, book_id, price): Records a new transaction.
#         list_user_transactions(user_email): Lists all transactions for a given user.
#     """
#     def __init__(self, file_path):
#         super().__init__(file_path)
#         self.transactions = self.load()

#     def record_transaction(self, user_email, book_id, price):
#         """
#         Records a new transaction.

#         :param user_email: Email of the user performing the transaction.
#         :param book_id: ID of the book being purchased.
#         :param price: Price of the book.
#         :return: The created Transaction object.
#         """
#         # Check if user already purchased the book
#         if any(tx["book_id"] == book_id and tx["user_email"] == user_email for tx in self.transactions):
...
#     def list_user_transactions(self, user_email):
#         """
#         Lists all transactions for a specific user.

#         :param user_email: Email of the user whose transactions are to be listed.
#         :return: List of Transaction objects for the user.
#         """
#         user_transactions = self.find({"user_email": user_email})
#         return [Transaction.from_dict(tx) for tx in user_transactions]
